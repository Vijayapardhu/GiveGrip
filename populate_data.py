...
def create_sample_data():
    ...
    # Try to import and create other data
    try:
        ...
        site_settings, created = SiteSettings.objects.get_or_create(
            defaults={
                ...
                'contact_address': '123 Fundraising Street, Charity City, CC 12345',
        ...
        for i, data in enumerate(campaign_data):
            campaign, created = Campaign.objects.get_or_create(
                ...
                defaults={
                    ...
                    'collected_amount': Decimal(str(random.randint(1000, int(float(data['goal_amount']) * 0.8)))),
        ...
        for campaign in campaigns:
            for i in range(random.randint(3, 8)):
                ...
                print(f'Created donation: ${amount} for {campaign.title}')
        ...
        print('Created sample donations, FAQs, and testimonials')
